...
# Delete cart item
# def delete_cartItem(request, menuItem_id):
#     cartItem = get_object_or_404(Cart, id=menuItem_id)
#     cartItem.delete()

#     rest = Cart.objects.all()
#     return render(request, 'delivery/cart.html', {"rest": rest})
